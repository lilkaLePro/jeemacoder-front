...
export default function FormInput({id , type, value, placeholder, className, label , onChange} : 
  {id :string , type : string , value :  string|number, placeholder : string, className: string, label : string , 
